...
//            System.setOut(printStream);
			...
			for (Pair<Command, Command> p : pairs) {
				...
				localizeInstancePairs(ips, aModel, p.a);
			}
		}
	}

	public void localizeInstancePairs(List<InstancePair> ips, AModel aModel, Command asst) {
		int i = 0;
...
//                System.out.println("inferred: " + possiblekeywords);
		...
		SliceVisitor sv = new SliceVisitor(asst);
		sv.visit(aModel);
